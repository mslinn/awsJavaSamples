...
public class JobStatusNotificationsSample {
    ...
    // This is the URL of the SQS queue that was created when setting up your AWS environment.
    ...
    static final private Object lock = "";
    ...
    private static void waitForJobToComplete(final String jobId, SqsQueueNotificationWorker sqsQueueNotificationWorker) throws InterruptedException {
        ...
        synchronized(lock) { // MOS: no longer synchronizing on a local variable
            handler.wait();
        }
